...
1. OCaml + ADT <details><summary>Подробнее</summary>
   * mini-ML с функциями обычными и анонимными, замыканиями и рекурсией, базовые типы: целые числа, bool.
   ...
   * исключения не надо
   * N.B. во всех задачах про OCaml нужнен и вывод типов, и интерпретатор.	
...
1. OCaml + records + bidirectional <details><summary>Подробнее</summary>
   * mini-ML с функциями обычными и анонимными, замыканиями и рекурсией, базовые типы: целые числа, bool.
	* поддержать синтаксис приписывания типов переменным.
